				...
				<div class="row">
					...
					<div class="col-lg-6 product_col">
						<div class="product_info">
							<div class="product_name">Eu vou deixar suas fotos mais profissionais!</div>
							<div class="product_category">Em <a href="category.html">Design</a></div>
							<div class="product_rating_container d-flex flex-row align-items-center justify-content-start">
								<div class="rating_r rating_r_4 product_rating"><i></i><i></i><i></i><i></i><i></i></div>
								<div class="product_reviews">4.7 de (14)</div>
								<div class="product_reviews_link"><a href="#">Análises</a></div>
							</div>
							<div class="product_price">R$15<span>.99</span></div>
							...
							<div class="product_buttons">
								<div class="text-right d-flex flex-row align-items-start justify-content-start">
									<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">ENTRAR EM CONTATO
									</div>
									<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">ADICIONAR AOS FAVORITOS
									</div>
							</div>
						</div>
					</div>
